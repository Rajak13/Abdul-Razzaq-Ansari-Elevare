...
function LoginForm() {
  ...
  useEffect(() => {
    if (searchParams.get('registered') === 'true') {
      setRegisteredMessage(t('registrationSuccess'));
      toast.success(t('registrationSuccessToast'));
    }
  }, [searchParams, t]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = errorMessage || tErrors('invalidCredentials');
      setErrors({
        submit: message,
      });
      toast.error(message);
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      {suspensionInfo ? (
        <div className="w-full flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12 bg-[#FCFBF7]">
        ...
        <>
          {/* Left Side - Form */}
          <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12 bg-white dark:bg-[hsl(0,0%,7%)]">
            ...
            <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 sm:py-3.5 px-4 bg-primary hover:bg-primary/90 text-white text-sm sm:text-base font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all text-sm sm:text-base"
                >
                ...
                {/* Facebook button commented out for now
                <button
                  type="button"
                  onClick={() => {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 items-center justify-center p-8 xl:p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md lg:max-w-lg w-full px-4">
          <img
            src={theme === 'light' ? "/images/Login.png" : "/images/Login(Alternate).png"}
